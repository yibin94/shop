...
.explode {
  background:url(/shop/Public/Admin/imgs/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/shop/Public/Admin/imgs/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/shop/Public/Admin/imgs/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/shop/Public/Admin/imgs/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <?php if(is_array($privileges)): foreach($privileges as $key=>$v): ?><li class="explode" key="02_cat_and_goods" name="menu">
                <?php echo ($v["pri_name"]); ?>
                <ul>
                  <?php if(is_array($v["children"])): foreach($v["children"] as $key=>$child): ?><li class="menu-item"><a href="<?php echo U($child["module_name"].'/'.$child["controller_name"].'/'.$child["action_name"]);?>" target="main-frame"><?php echo ($child['pri_name']); ?></a></li><?php endforeach; endif; ?>
                </ul>
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Goods/listGoods');?>" target="main-frame">商品列表</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
            类别管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Category/listCate');?>" target="main-frame">商品分类列表</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
            权限管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Privilege/listPri');?>" target="main-frame">权限列表</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
            角色管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Role/listRole');?>" target="main-frame">角色列表</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
            管理员管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Admin/listAdmin');?>" target="main-frame">管理员列表</a></li>
                </ul>
            </li>-->
        </ul>
    </div>
...
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/shop/Public/Admin/imgs/menu_minus.gif' : '/shop/Public/Admin/imgs/menu_plus.gif';
