...
<form action="<?php echo U('Login/login');?>" method="post" onsubmit="">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <img id="verify" onclick="this.src='<?php echo U('Login/verify');?>#'+Math.random()" src="<?php echo U('Login/verify');?>" />
                            <a href="#" onclick="$('#verify').attr('src','<?php echo U("Login/verify");?>#'+Math.random());" style="color:#FFF;">
                                看不清?换一张
                            </a>
                        </td>
                    </tr>
