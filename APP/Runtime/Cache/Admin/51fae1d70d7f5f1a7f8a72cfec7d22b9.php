...
<div class="list-div" id="listDiv">
	<table cellpadding="3" cellspacing="1">
        ...
        <?php if(is_array($roleRes)): foreach($roleRes as $key=>$v): ?><tr class="tron">
    				<td align="center"><?php echo ($v["role_name"]); ?></td>
                    <td align="center"><?php echo ($v["pri_name"]); ?></td>
    		        <td align="center">
    		        	<a href="<?php echo U('Role/modify',array('id'=>$v['id'],'p'=>$pageIndex));?>" title="修改">修改</a> |
    	                <a href="<?php echo U('Role/delete',array('id'=>$v['id'],'p'=>$pageIndex));?>" onclick="return confirm('确定要删除吗？');" title="移除">移除</a> 
    		        </td>
